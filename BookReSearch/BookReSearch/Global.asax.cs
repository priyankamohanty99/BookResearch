    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            DefaultModel.RegisterContext(new Microsoft.AspNet.DynamicData.ModelProviders.EFDataModelProvider(() => 
                new BookReSearchEntities()), new ContextConfiguration { ScaffoldAllTables = true });
        ...
        private static void RegisterScripts()
        {
            ScriptManager.ScriptResourceMapping.AddDefinition("jquery", new ScriptResourceDefinition
            {
                ...
                CdnPath = "http://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.1.0.min.js",
                CdnDebugPath = "http://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.1.0.js",
        ...
        protected void Application_Error(Object sender, EventArgs e)
        {
            ...
            if (bigError != null && bigError.GetBaseException() is System.Data.SqlClient.SqlException)
            {
                Server.Transfer("/ErrorDb.aspx");
            }
        }
